...
function Activate() {
  ...
  useEffect(() => {
    ...
    supabase.functions
      .invoke("kodacloud-claim", { body: { claim_token: token } })
      .then(({ data, error: activationError }) => {
        ...
        setActivatedDeviceId(data?.device?.device_id ?? null);
        setState("success");
      });
  }, [token, loading, user]);
        ...
        {loading ? (
          ...
          <div className="max-w-xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-[#6e6e73]">
              Durante o primeiro setup, o aparelho valida sua identidade com a KodaCloud e abre uma
              sessão temporária de ativação. Você não precisa — e não pode — reivindicar um produto
              apenas digitando o número de série.
            </p>
            <a
          ...
          <div className="max-w-xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-[#6e6e73]">
              Este KodaBot já iniciou uma sessão segura de ativação. Entre ou crie a Conta KodaCloud
              que será a proprietária do produto.
            </p>
          ...
          <div className="max-w-lg text-center">
            ...
            <p className="mt-4 text-sm leading-relaxed text-[#6e6e73]">
              Estamos vinculando o aparelho à sua Conta KodaCloud.
            </p>
          </div>
        ) : state === "success" ? (
          <div className="max-w-lg text-center">
            ...
            <p className="mt-4 text-sm leading-relaxed text-[#6e6e73]">
              O produto foi vinculado automaticamente à sua Conta KodaCloud e agora aparece em Meu
              KodaBot com garantia, software, manuais e suporte.
            </p>
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <a
                href={activatedDeviceId ? `/conta/dispositivo/${activatedDeviceId}` : "/conta"}
                className="inline-flex rounded-full bg-[#0071e3] px-7 py-3 text-sm font-semibold text-white"
              >
                Abrir Meu KodaBot
              </a>
              <a
